# Generated by Django 4.2.6 on 2024-12-25 14:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('callback_url', models.URLField(blank=True, editable=False, max_length=255, null=True, verbose_name='آدرس کال بک')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='payment.order', verbose_name='ترتیب:')),
            ],
            options={
